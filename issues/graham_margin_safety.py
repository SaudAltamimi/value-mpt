...
class ValuationMetrics:
    ...
    def __init__(self, financial_data: FinancialData):
        ...
        self.current_assets = float(ClaudeAgent("""You are an expert financial analyst assistant,
                                     when a user asks you to do something you do it.""",
                                     f"""Calculate the total current assets for the newest year within this document: {self.financial_data.balance_sheet}. only return it as a float,
                                     do not give me any explanation or anything, only output a float.""", api_key).send_request())
        self.total_liabilities = float(ClaudeAgent("""You are an expert financial analyst assistant,
                                     when a user asks you to do something you do it.""",
                                     f"""Calculate the total current liabilities for the newest year within this document: {self.financial_data.balance_sheet}. only return it as a float,
                            do not give me any explanation or anything, only output a float.""", api_key).send_request())
